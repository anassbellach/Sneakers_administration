...
<head>
  ...
  <title><?=$this->buildPageTitle($data); ?>Sneaker administratie</title>
</head>
<body>
  <div class="app-ui js-app-ui">
    ...
    <header class="app-ui__header shadow-xs padding-x-md padding-x-0@md">
      <div class="app-ui__logo-wrapper padding-x-sm@md">
        <a href="<?= URLROOT ?>" class="app-ui__logo">
          ...
          <nav class="sidenav padding-y-sm js-sidenav">
            ...
            <ul class="sidenav__list">
              <li class="sidenav__item">
                <a href="<?= URLROOT ?>" class="sidenav__link" aria-current="page">
              ...
              <li class="sidenav__item sidenav__item--expanded">
                <a class="sidenav__link js-sidenav__sublist-control js-tab-focus" style="cursor: pointer">
