...
<main class="app-ui__body padding-md js-app-ui__body">
    <div class="margin-bottom-md">
        <h1 class="text-lg">Sneaker Brands</h1>
    </div>
...
<!--            </div>-->
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        if($data['Brands']) {?>
                            ...
                            foreach ($data['Brands'] as $Brands):?>
                                <tr class="int-table__row">
                                    <td class="int-table__cell"><?=$Brands->brandsId ?></td>
                                    <td class="int-table__cell"><?=$Brands->brandsName ?></td>
                                    <td class="int-table__cell text-right">
                                        <a class="btn btn--primary" href="<?=URLROOT ?>BrandsController/update?userid=<?=$Brands->brandsId?>">Update</a>
                                        <a class="btn btn--primary" href="<?=URLROOT ?>BrandsController/delete?userid=<?=$Brands->brandsId?>">Delete</a>
                                    </td>
                                </tr>
                            <?php
                            endforeach;
        ...
        <div class="border-top border-alpha padding-md">
            <div class="flex flex-wrap gap-xs justify-between">
                ...
                <a href="<?=URLROOT ?>BrandsController/create" class="btn btn--primary">Create</a>
            </div>
        </div>
    </div>
